...
**Important note (new functionality):** We can also measure the importance of variables using global SurvSHAP(t) explanations. Details on how to do so, are presented in this vignette.

## Partial dependence

**Important note (new functionality):** A more detailed description of the partial dependence explanation, with added functionality is presented in this vignette.
