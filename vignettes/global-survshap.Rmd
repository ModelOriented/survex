...
For `kind = "beeswarm"` a bee swarm plot is generated that shows the SHAP values for each observation. The swarm plot is a good way to assess the distribution of SHAP values for each variable.

```{r}
plot(shap, kind = "beeswarm")
```
