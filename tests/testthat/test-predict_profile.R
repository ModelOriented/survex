test_that("ceteris_paribus works", {
    ...
    plot(cph_pp, geom = "variable", times=cph_exp$times[1])
    ...
    plot(cph_pp, geom = "variable", variables = "karno", marginalize_over_time = TRUE)
    ...
    plot(cph_pp_centered, geom = "variable", variables = "karno")
